...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Ocean Paradise HOTEL,</p>
				<p>Saidpur Cantonment Road,<br>Nilphamari,<br>Bangladesh.</p>
				<p>+8801723667397</p>
			</address>
			<span><img alt="" src="assets/img/ocean.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@Oceanparadise.com || Web :- www.oceanparadise.com || Phone :- +8801723667397 </p>
			</div>
		</aside>
	</body>
</html>
